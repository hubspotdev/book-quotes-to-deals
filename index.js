...
const getContact = async (accessToken) => {
  ...
  try {
    ...
    console.log('===> request.get(\'https://api.hubapi.com/crm/v3/objects/contacts?limit=5\')');
    const result = await request.get('https://api.hubapi.com/crm/v3/objects/contacts?limit=5', {
      headers: headers
    });
